...
public class Camera
{
	...
	/**
	 * A function to rotate the camera's yaw.
	 * @param amt The angle in radians by which to rotate the camera's yaw.
	 */
	...
	/**
	 * A function to rotate the camera's pitch.
	 * @param amt The angle in radians by which to rotate the camera's pitch.
	 */
	...
	/**
	 * A function to rotate the camera's roll.
	 * @param amt The angle in radians by which to rotate the camera's roll.
	 */
	...
	/**
	 * A function to move the camera along the Y axis.
	 * @param amt The amount by which to rotate the camera along the Y axis.
	 */
	public void moveY(float amt) {	// Move Up/Down
		location.add(new Vector3f(v).mul(amt));
	}
	/**
	...
	public void moveX(float amt) { // Move Left/Right
		location.add(new Vector3f(u).mul(amt));
	}
	/**
	...
	public void moveZ(float amt) {	// Move Forward/Backward
		location.add(new Vector3f(n).mul(amt));
	}
}