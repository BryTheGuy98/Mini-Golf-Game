...
public class RotationController extends NodeController
{
	...
	/** Creates a default rotation controller with vertical axis, and speed=1.0. */
	public RotationController() { super(); }

	/**
	 * Creates a rotation controller with specified variables.
	 * @param e the game engine.
	 * @param axis the axis to which the object will be moved along.
	 * @param speed the rate at which the object will move.
	 */
